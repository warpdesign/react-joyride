...
var JoyridePortal = class extends React3.Component {
  constructor() {
    ...
    __publicField(this, "rootNode", null);
  }
  componentDidMount() {
    const { id } = this.props;
    if (!canUseDOM()) {
...
function JoyrideTooltipContainer(props) {
  ...
  if (!hideBackButton && index > 0) {
    output.back = /* @__PURE__ */ React6.createElement("button", { "data-test-id": "button-back", style: styles.buttonBack, type: "button", ...backProps }, backProps.title);
  }
